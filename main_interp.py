...
def connect_to_router(router):
    ...
    try:
        ...
        ssh_client.connect(ip, username=username, password=password, port=port)
...
with open("bind_data_kk.yml", "r") as config_file:
    config_data = yaml.safe_load(config_file)

# Muat templates Jinja2
env = Environment(loader=FileSystemLoader(""))
template = env.get_template("templates_kk.j2")
